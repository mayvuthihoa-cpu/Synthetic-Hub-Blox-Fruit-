...
------ Tab
     local Tab1o = MakeTab({Name = "All Menu Script"})
     local Tab1o = MakeTab({Name = "???"})
------- BUTTON
...
loadstring(game:HttpGet("https://raw.githubusercontent.com/LuaCrack/DatThg/refs/heads/main/DatThgV2"))()
  ...
  AddButton(Tab1o, {
    ...
    Callback = function()
    getgenv().Team = "Marines"
loadstring(game:HttpGet("https://raw.githubusercontent.com/LuaCrack/Loader/refs/heads/main/XeterV3"))()%60%60%60
